...
<head>
    ...
    <link href="<?php echo URL::get_site_url() ?>/public/dashboard/assets/css/pages/error.css" rel="stylesheet"
          type="text/css"/>
    <?php
    if (isset($this->css)) {
        $i = 0;
        while (isset($this->css[$i])) {
            echo "<link href='" . URL::get_site_url() . "/public/dashboard/assets/" . $this->css[$i] . "' rel='stylesheet' type='text/css' />\n";
            $i++;
        }
    }
    ?>
...
<a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
    <img src="<?php echo URL::get_site_url() ?>/public/dashboard/assets/img/menu-toggler.png" alt=""/>
</a>
        ...
        <li>
            <ul class="dropdown-menu-list scroller" style="height: 250px;">
                <li>
                    <a href="inbox.html?a=view">
                        <span class="photo"><img
                                src="<?php echo URL::get_site_url() ?>/public/dashboard/assets/img/avatar2.jpg" alt=""/></span>
                           <span class="subject">
                ...
                <li>
                    <a href="inbox.html?a=view">
                        <span class="photo"><img
                                src="<?php echo URL::get_site_url() ?>/public/dashboard/assets/img/avatar3.jpg" alt=""/></span>
                           <span class="subject">
                ...
                <li>
                    <a href="inbox.html?a=view">
                        <span class="photo"><img
                                src="<?php echo URL::get_site_url() ?>/public/dashboard/assets/img/avatar1.jpg" alt=""/></span>
                           <span class="subject">
...
<li class="dropdown user">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        <img alt="" src="<?php echo URL::get_site_url() ?>/public/dashboard/assets/img/avatar1_small.jpg"/>
        <span class="username"><?php echo UserInfo::getUsername(); ?></span>
        <i class="icon-angle-down"></i>
    </a>
    <ul class="dropdown-menu">
        <li><a href="<?php echo URL::get_site_url() . '/admin/dashboard/user_profile/' . UserInfo::getUserId(); ?>"><i
        ...
        <li><a href="<?php echo BASE_PATH ?>admin/dashboard/logout"><i class="icon-key"></i> Log Out</a>
        </li>
    </ul>
</li>
