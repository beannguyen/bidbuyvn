var Inbox = function () {
    ...
    var loadMessage = function (el, name, resetMenu) {
        ...
        $.ajax({
            ...
            success: function(res) 
            {
                ...
                $('.inbox-header > h1').text('Xem tin nhắn');
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["../public/dashboard/assets/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '../public/dashboard/assets/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    var loadSearchResults = function (el) {
        var url = 'user_inbox_search_result';
